...
def process_group(days_to_plot, start_date, folder, known_tags, discard_unit=None, discard_date=None):
    mean_weights = []
    sem_weights = []
    x_values = []
...
# Process groups
x_experimental, mean_experimental, sem_experimental = process_group(
    days_to_plot_exp, start_date_exp, folder_experimental, known_tags_experimental, discard_unit=3, discard_date=date(2025, 2, 2)
)
x_control, mean_control, sem_control = process_group(
